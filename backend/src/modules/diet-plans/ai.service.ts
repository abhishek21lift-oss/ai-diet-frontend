...
- Use Indian foods where appropriate (roti, dal, rice, paneer, etc.)
- Each meal should have 2-4 food items
- Provide practical quantities (grams, cups, pieces)
- Include 2-3 alternatives per food item
- Ensure macros add up to daily targets
- Consider pre/post workout nutrition
...
RESPOND WITH THIS EXACT JSON STRUCTURE:
{
  ...
  "hydrationTips": "Drink at least 3-4 litres of water daily...",
  "supplementSuggestions": ["Whey Protein", "Creatine 5g", "Multivitamin"],
  "trainerNotes": "Key coaching notes for this client..."
}
`.trim();
}
